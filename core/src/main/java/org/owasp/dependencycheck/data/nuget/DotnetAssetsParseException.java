...
/**
 * Exception during the parsing of a project.assets.json file.
 *
 * @author doshyt
 */
@ThreadSafe
public class DotnetAssetsParseException extends Exception {
     ...
     */
    public DotnetAssetsParseException() {
        super();
    }
     ...
     */
    public DotnetAssetsParseException(String message) {
        super(message);
    }
     ...
     * unknown).
     */
    public DotnetAssetsParseException(String message, Throwable cause) {
        super(message, cause);
    }
}
