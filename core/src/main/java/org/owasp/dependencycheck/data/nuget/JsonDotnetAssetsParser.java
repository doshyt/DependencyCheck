 ...
 */
@ThreadSafe
public class JsonDotnetAssetsParser implements DotnetAssetsParser {
    /**
     * Parse an input stream and return the resulting {@link NugetPackage}.
     *
     * @param stream the input stream to parse
     * @return the populated bean
     * @throws DotnetAssetsParseException when an exception occurs
     */

    @Override
    public List<NugetPackageReference> parse(InputStream stream) throws DotnetAssetsParseException {
        try {
            /*
            ...
            if (nodeList == null) {
                throw new DotnetAssetsParseException("Unable to parse packages.config file");
            }
            ...
            */
            ...
            return packages;
        } catch (ParserConfigurationException | SAXException | IOException | XPathExpressionException | DotnetAssetsParseException e) {
            throw new DotnetAssetsParseException("Unable to parse packages.config file", e);
        }
    }
}
